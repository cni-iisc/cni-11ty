...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.addCollection("posts", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./posts/*.md", "./posts/*.html"]).reverse();
  });
  ...
  eleventyConfig.addCollection("schools", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./schools/*.md", "./schools/*.html"]);
  });
  eleventyConfig.addCollection("hackathons", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./hackathons/*.md", "./hackathons/*.html"]);
  });
  eleventyConfig.addCollection("workshops", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./workshops/*.md", "./workshops/*.html"]);
  });

  eleventyConfig.addCollection("courses", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./courses/*.md", "./courses/*.html"]);
  });

  eleventyConfig.addCollection("covidResponses", function(collectionApi) {
    return collectionApi.getFilteredByGlob(["./covidresponse/*.md", "./covidresponse/*.html"]);
  });

    eleventyConfig.addCollection("projects", function(collectionApi) {
      return collectionApi.getFilteredByGlob(["./projects/*.md", "./projects/*.html"]);
    });
    ...
    eleventyConfig.addCollection("Fellows", function(collectionApi) {
      return collectionApi.getFilteredByGlob("./_people/*.md").filter(person => 
        person.data.category === "Ph.D. Fellows/Scholars" || person.data.category === "M.Tech. Fellows/Scholars"
      );
    });

    eleventyConfig.addCollection("Staff", function(collectionApi) {
      return collectionApi.getFilteredByGlob("./_people/*.md").filter(person => 
        person.data.category === "Staff"
      );
    });

    eleventyConfig.addCollection("Faculty", function(collectionApi) {
      return collectionApi.getFilteredByGlob("./_people/*.md").filter(person => 
        person.data.category === "Faculty"
      );
    });
